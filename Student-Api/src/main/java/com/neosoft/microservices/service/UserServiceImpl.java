...
import com.neosoft.microservices.repo.UserDao;
...
public class UserServiceImpl implements UserDetailsService, UserService{
    ...
    public User save(UserDTO user) {
        ...
        nUser.setPassword(bcryptEncoder.encode(nUser.getPassword()));
        ...
        // will be admin if contains admin as username
        if(nUser.getUsername().toLowerCase().contains("admin")){
